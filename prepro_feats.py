...
sys.path.append("~/lijiguo/workspace/ImageCaptioning.pytorch/")
print(sys.path)
...
if __name__ == "__main__":
   ...
   # python scripts/prepro_labels.py --input_json data/dataset_coco.json --output_json data/cocotalk.json --output_h5 data/cocotalk
    ...
    # input json
    parser.add_argument('--input_json', default='./cocotalk_data/dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--output_dir', default='./cocotalk_data/cocotalk_image', help='output json file')
    ...
    parser.add_argument('--model_root', default='./model_weights', type=str, help='model root')
